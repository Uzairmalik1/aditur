      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            <Link href="https://www.tiktok.com/@sendshortai" target="_blank">
              <FaTiktok className="text-2xl hover:text-gray-400" />
            </Link>
            <Link href="https://x.com/sendshort" target="_blank">
              <FaTwitter className="text-2xl hover:text-gray-400" />
            </Link>
            <Link href="https://www.instagram.com/sendshort.ai/" target="_blank">
              <FaInstagram className="text-2xl hover:text-gray-400" />
            </Link>
            <Link href="https://www.youtube.com/@SendShort_" target="_blank">
              <FaYoutube className="text-2xl hover:text-gray-400" />
            </Link>
            <Link href="https://www.linkedin.com/company/sendshort/" target="_blank">
