...
export default function VideoPreview({ videoSrc, isYoutube, videoRef }: VideoPreviewProps) {
    return (
        <div className="relative w-[63rem] bg-bgWhite rounded-lg shadow-md border">
            {/* Video Preview */}
            <div className="flex-1 flex flex-col items-center justify-center p-4">
                <div className="relative w-[290px]  h-[32rem] bg-black rounded-2xl">
                        ...
                        {videoSrc ? (
                            <div className="flex flex-col items-center">
                                ...
                                {isYoutube ? (
                                    ...
                                    <video ref={videoRef} className="w-full max-w-2xl rounded-lg shadow-md">
